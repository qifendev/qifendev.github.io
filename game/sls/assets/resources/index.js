System.register("chunks:///_virtual/en.ts", ['cc'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      cclegacy._RF.push({}, "ca21aUgHudFZKJ4cz/fdIqc", "en", undefined);
      ...
      var languages = exports('languages', {
        ...
        "fight": {
          ...
          "direct_start": "<color=#ffffff><u>Start</u></color>",
          "restart_start": "<color=#ffffff><u>Play Again</u></color>"
        },
        "lottery": {
        ...
        "offlineReward": {
          ...
          "receive_3times": "Receive X3"
        },
        "shop": {
          "receive": "Receive it"
        },
        "reward": {
          "normal_receive": "<color=#ffffff><u>Receive</u></c>"
        },
        "testLable": {
          "myButtonName": "Receive",
          "myLableShow": "DataShow"
        }
      });
...
System.register("chunks:///_virtual/zh.ts", ['cc'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      cclegacy._RF.push({}, "f5034jWLxVDm6kdhgPzlihH", "zh", undefined);
      ...
      var languages = exports('languages', {
        ...
        "fight": {
          ...
          "needCollect": "你还需收集",
          "direct_start": "<color=#ffffff><u>直接开始</u></color>",
          "restart_start": "<color=#ffffff><u>重新开始</u></color>"
        },
        "lottery": {
        ...
        "offlineReward": {
          "welcome_back": "欢迎回来",
          "receive_3times": "3 倍领取"
        },
        "shop": {
          "receive": "立即领取"
        },
        "reward": {
          "normal_receive": "<color=#ffffff><u>普通领取</u></c>"
        },
        "testLable": {
          "myButtonName": "接收",
          "myLableShow": "数据显示"
